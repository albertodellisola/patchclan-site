...
export const YYHG = {
  ...
  fotos: [
    { f: 'yyhg/01-titulo.png', t: bi('Tela de título', 'Title screen', 'Pantalla de título'),
      c: bi('O logo novo, com GAIDEN, usa as cores que o jogo já carregava: ele entra no fade e escurece atrás do menu de opções, como o original.',
            'The new GAIDEN logo uses the colours the game already loaded: it joins the fade and dims behind the options menu, like the original.',
            'El logo nuevo, con GAIDEN, usa los colores que el juego ya cargaba: entra en el fundido y se oscurece tras el menú de opciones, como el original.') },
