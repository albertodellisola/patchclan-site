export const CT = {
  ...
  patch: { versoes: { en: { arquivo: 'captain-tsubasa-en.ips' }, pt: { arquivo: 'captain-tsubasa-pt.ips' }, es: { arquivo: 'captain-tsubasa-es.ips' } }, rom: 'Captain Tsubasa (Japan).nes', rom_md5: 'eeb77e6e0e0b5695f9a35f47979c4722' },
  fotos: [
