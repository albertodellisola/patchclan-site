...
export const GORILLA_FIX = {
  ...
  grupos: [
    ...
    { titulo: bi('Como foi conferido', 'How it was checked', 'Cómo se comprobó'), itens: [
      { t: bi('<b>Os dois bugs foram reproduzidos na ROM japonesa original</b>: os cenários 1 e 2 travaram em <code>$BA08</code> logo depois da ilustração do final, e com vida 1 nos seis personagens o primeiro a zerar levou todos ao GAME OVER.',
              '<b>Both bugs were reproduced on the original Japanese ROM</b>: scenarios 1 and 2 locked up at <code>$BA08</code> right after the ending illustration, and with 1 HP on all six characters the first to fall took everyone to GAME OVER.',
              '<b>Los dos fallos se reprodujeron en la ROM japonesa original</b>: los escenarios 1 y 2 se colgaron en <code>$BA08</code> justo después de la ilustración del final, y con 1 de vida en los seis personajes el primero en caer llevó a todos al GAME OVER.') },
