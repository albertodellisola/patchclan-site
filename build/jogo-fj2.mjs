export const FJ2 = {
  ...
  patch: {
    versoes: { en: { arquivo: 'famicom-jump-2-en.ips' },
               ...
               es: { arquivo: 'famicom-jump-2-es.ips' } },
  ...
  fotos: [
    ...
    { f: 'fj2/05-espirito-jump-world.png', t: { pt: 'O espírito do Jump World', en: 'The spirit of Jump World' }, c: { pt: 'A abertura, agora em português.', en: 'The opening, now in English.' } },
